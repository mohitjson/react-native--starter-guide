...
function CounterOne() {
  ...
  return (
    <View>
      ...
      <Button onPress={()=> dispatchTwo('increment')}  title='increment'></Button>
      <Button onPress={()=>dispatchTwo('decrement')} title='decrement'></Button>
      <Button onPress={()=>dispatchTwo('reset')} title='reset'></Button>
